...
function gaussianElimination(matrix::Matrix, vector::Vector, returnInverse=nothing)
...
matrix2 = [1 2 3; 2 4 7; 3 7 11]
vector2 = [1, 2, 2]

result1 = gaussianElimination(matrix1, vector1, true)
